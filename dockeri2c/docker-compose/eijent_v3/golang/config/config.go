...
type SenserConfig struct {
	...
	MMA8452Q_Count   int    `env:"MMA8452Q_INTERVAL" envDefault:"500"`   //MMA8452Qのセンサーのインターバル ms
	BMX055_Count     int    `env:"BMX055_INTERVAL" envDefault:"5"`       //BMX055のセンサーのインターバル µs
	BMX055_ARY_MAX   int    `env:"BMX055_ARY_MAX" envDefault:"1000"`     //BMX055のセンサーが読み取ったときに保持する過去データの値の数
...
func Init() error {
	...
	if Senser.BMX055_ARY_MAX < 200 {
		Senser.BMX055_ARY_MAX = 200
	}
	return nil
}
